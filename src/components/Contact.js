...
export default function Contact(props) {
    ...
    return (
        <section id="contact" className="min-h-screen">
            ...
            <form className="lg:w-1/2 md:w-full p-5 mx-auto mt-5">
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide text-gray-700 lg:text-lg md:text-xs font-bold mb-2" for="grid-first-name">
                            First Name
                         </label>
                    ...
                    <div className="w-full md:w-1/2 px-3">
                        <label className="block uppercase tracking-wide text-gray-700 lg:text-lg md:text-xs font-bold mb-2" for="grid-last-name">
                            Last Name
                         </label>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        <label className="block uppercase tracking-wide text-gray-700 lg:text-lg md:lg:text-lg md:text-xs font-bold mb-2" for="grid-password">
                            E-mail
                      </label>
                ...
                <div className="flex flex-wrap -mx-3 mb-6"> 
                    <div className="w-full px-3">
                        <label className="block uppercase tracking-wide text-gray-700 lg:text-lg md:text-xs font-bold mb-2" for="grid-password">
                            Message
                      </label>
